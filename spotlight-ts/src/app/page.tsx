...
import portraitImage from '@/images/photos/Portrait-futuriste-thomas.png'
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image1, portraitImage, image3, image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
...
export default function Home() {
  return (
    <>
      <Container className="mt-9 scroll-mt-28 sm:scroll-mt-32" id="about">
        <div className="max-w-2xl">
          ...
          <AboutStoryParagraphs className="mt-6" />
